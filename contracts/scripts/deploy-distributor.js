...
const artifact = JSON.parse(
  readFileSync(resolve(__dirname, "../artifacts/contracts/BNDistributor.sol/BNDistributor.json"), "utf-8")
);
...
async function main() {
  console.log("📡 Deploying BNDistributor to Base mainnet...");
  ...
  console.log(`\n✅ BNDistributor deployed to: ${receipt.contractAddress}`);
  console.log(`   Explorer: https://basescan.org/address/${receipt.contractAddress}`);
  console.log(`\n📋 Next: Send BREAKING NEWS tokens to this address to fund it.`);
}
